...
**All prayer times are calculated locally using pure astronomical formulas** — please refer to [docs](docs/) for more information. Muslimtify currently supports the **Kemenag** (Indonesian Ministry of Religious Affairs) calculation method, more methods may be added in the future.
